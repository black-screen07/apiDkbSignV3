...
def sign_pdf():
    ...
    try:
        ...
        input_pdf_buffer = sign_pdf_pages(input_pdf_buffer, pages, signer, signer_stamp)
...
def sign_document():
    ...
    try:
        ...
        input_pdf_buffer = sign_pdf_pages(input_pdf_buffer, pages, signer_obj, signer_stamp_img)
